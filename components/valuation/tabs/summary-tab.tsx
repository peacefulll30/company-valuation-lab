    ...
    return (
      <div className="flex flex-col gap-6">
        <div>
          ...
          <h1 className="mt-1 font-display text-2xl font-medium sm:text-3xl">Valuation Summary</h1>
        </div>
    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="rounded-md border border-border bg-card p-4">
          <p className="font-mono text-xs text-muted-foreground uppercase">Base fair value</p>
          <p className="mt-1 font-display text-xl">{formatCurrency(dcf.impliedSharePrice)}</p>
        </div>
        <div className="rounded-md border border-border bg-card p-4">
          <p className="font-mono text-xs text-muted-foreground uppercase">Range (Bear&ndash;Bull)</p>
          <p className="mt-1 font-display text-xl tabular-nums">
            {formatCurrency(low)}&ndash;{formatCurrency(high)}
          </p>
        </div>
        <div className="rounded-md border border-border bg-card p-4">
          <p className="font-mono text-xs text-muted-foreground uppercase">Upside / downside vs. price</p>
